...
- Reminders to use `file_write` for HTML creation and `browser_use(action="screenshot")` for verification
...
and verify the result with `browser_use(action="screenshot")` to confirm visual accuracy.
